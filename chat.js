...
(function () {
  ...
  function init() {
    ...
    root.innerHTML =
      ...
      '<div class="cpc-chat-head"><strong>Pool Compliance Help</strong><span>Instant answers, Mon to Fri follow-up</span><button class="cpc-chat-close" aria-label="Close chat">&times;</button></div>' +
